...
This release is a **BREAKING** change. We are now using the [matrix-bot-sdk](https://github.com/turt2live/matrix-bot-sdk) under the hood. While the library has kept the same
