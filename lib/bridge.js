 ...
 * @param {Bridge~onAliasQueried=} opts.controller.onAliasQueried Function. If supplied,
 * the bridge will invoke this function when queried via onAliasQueried. Will
 * be called when a room has been created via onAliasQuery.
