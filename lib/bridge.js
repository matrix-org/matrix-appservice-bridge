...
function Bridge(opts) {
    ...
    this._intentBackingStore = {
        setMembership: this.setMemberEntry.bind(this),
        setPowerLevelContent: this._setPowerLevelEntry.bind(this),
        getMembership: this.getMemberEntry.bind(this),
...
Bridge.prototype.run = function(port, config, appServiceInstance) {
    ...
    this._appServiceBot = new AppServiceBot(
        this._botClient, self.opts.registration, (userId, roomId) => {
            this.setMemberEntry(roomId, userId, "join");
        }
    );
...
Bridge.prototype.getIntent = function(userId, request) {
    ...
    if (!this._intents[key]) {
        ...
        clientIntentOpts.registered = this._registeredUsers.has(userId);
 ...
 *                       e.g joined.
 */
Bridge.prototype.setMemberEntry = function(roomId, userId, membership) {
 ...
 */
Bridge.prototype.getMemberEntry = function(roomId, userId) {
    if (!this._membershipMap[roomId]) {
        return null;
    }
