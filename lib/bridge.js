...
Bridge.prototype.provisionUser = function(matrixUser, provisionedUser) {
    ...
    // v1 registration. If you update this to use v2 registration, you MUST rename 'user' to 'username'
    // for supporting earlier synapses which broke the API for AS registration.
    // See https://github.com/matrix-org/synapse/pull/727
    // See intent.js:514 for matching registration code FIXME
    console.log("QUERY PROV");
    var promise = self._botClient._http.authedRequestWithPrefix(
        undefined, "POST", "/register", undefined,
        {
            type: "m.login.application_service",
            user: matrixUser.localpart
