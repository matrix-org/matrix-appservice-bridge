 ...
 * command.
 * @param {AdminCommand~opts=} opts.opts An optional object giving commandline
 * options recognised by the command.
 ...
 * be parsed for optional arguments as per the command's opts specification, if
 * present.
 ...
 * @typedef {Object} AdminCommand~opts
