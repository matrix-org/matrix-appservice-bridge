...
class AgeCounters {
     ...
     * used by the gauge. It is in the format of '#X' where # is the period and X is the
     * unit of time. A unit can be one of 'h, d, w' for hours, days and weeks. 7d would
     * be 7 days. If not given, the periods are 1h, 1d and 7d.
     */
    constructor(counterPeriods) {
        ...
        counterPeriods.forEach((periodKey) => {
            ...
            if (isNaN(number)) {
                throw Error("The period duration is invalid.");
            }
