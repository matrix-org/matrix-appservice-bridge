...
Intent.prototype._ensureJoined = function(roomId) {
    ...
    */
    ...
    self.client.joinRoom(roomId).then(function() {
        mark(roomId, "join");
    }, function(e) {
        ...
        self.botClient.invite(roomId, userId).then(function() {
            return self.client.joinRoom(roomId);
        }).done(function() {
            mark(roomId, "join");
        }, function(invErr) {
            // Try bot joining
            self.botClient.joinRoom(roomId).then(function() {
...
Intent.prototype._ensureHasPowerLevelFor = function(roomId, eventType) {
    ...
    return this.client.getStateEvent(roomId, "m.room.power_levels", "").then(
    function(e) {
