...
var JungleUser = require("../models/users/jungle");
...
/**
 * Create a link between a matrix and jungle user. If either user does not exist,
 ...
 * @return {Promise}
 */
UserBridgeStore.prototype.linkUsers = function(matrixUser, jungleUser) {
    var self = this;
